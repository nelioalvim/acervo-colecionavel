export default async function handler(req, res) {
  ...
  const prompt = `Voce e um especialista em games retro. Pesquise precos atuais para: "${itemName}". Mercado Livre Brasil (BRL) e eBay/PriceCharting (USD). Responda APENAS JSON: {"marketBR": numero_ou_null, "marketExt": numero_ou_null}`
